<?php
	...
	if($url == 'editaItem'){
		...
		if(strip_tags($_POST['peso']) != null)
			$peso = 'PESO = '. strip_tags($_POST['peso']).', ';
		...
		$sql_edit = "UPDATE PRODUTO SET DESCRICAO_PRODUTO = '". $desc ."', APELIDO_PRODUTO = ". $nick.", GRUPO_PRODUTO=". $grupo .", SUBGRUPO_PRODUTO = ". $sgrupo .", SITUACAO = '". $sit ."', ". $peso ." CLASSIFICACAO_FISCAL = ". $class .",  ". $codigo ." COLECAO = ". $colecao ." WHERE PRODUTO = ". $prod;
		//echo $sql_edit;
